...
<header class="" id="km-header">
  ...
  <div id="empresa" style="padding:20px;margin:1px;">
    ...
    <form class="register-form" action="<?= site_url("AtendimentoPedidosFuncionario/notificar") ?>" method="POST" enctype="multipart/form-data">
      <h2 class="display-4" style="font-size: 35px;">Notificar Cliente</h2>
      <fieldset>
        <div class="form-row">
          <div class="col-12 col-sm-12 col-md-12">
            <div id="lp-mail-wrapper">
              <label for="formGroup1"><b>Nome*</b></label>
              <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="<?echo $dados['nome_cliente']?>">
            </div>
          ...
          <div class="col-12 col-sm-12 col-md-12">
            <div id="lp-name-wrapper">
              ...
              <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?echo $dados['email']?>">
            </div>
            <div style='color:blue;'></div>
          </div>
          ...
          <div class="col-12 col-sm-12 col-md-12">
            <div id="lp-lastname-wrapper">
              <label for="formGroup1"><b>Mensagem*</b></label>
