...
<head>
    ...
    <title> Tela pedidos de Bebidas Finalizados </title>
...
<body>
    ...
    <div id="empresa" style="padding:20px;margin:1px;">
        ...
        <div>
            <div class="container">
                <h2 class="display-4" style="font-size: 35px;">Lista de Pedidos de Bebidas Finalizados</h2>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($listagem as $item) : ?>
                                <tr>
                                    ...
                                    <td> <a href='<?= $url = site_url("listagemPedidosFinalizadosAdminBebida/deletar/{$item['id_pedido']}") ?>'>
