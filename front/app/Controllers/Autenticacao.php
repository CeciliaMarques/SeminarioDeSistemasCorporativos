...
class Autenticacao extends BaseController
{
  ...
  public function index()
  {
    ...
    $client = new Google_Client(['client_id' => '309876707711-g5pguvj237avtedbqj1a5g4g1ucs6vmb.apps.googleusercontent.com']);  // Specify the CLIENT_ID of the app that accesses the backend
